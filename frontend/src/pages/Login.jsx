...
export default function Login() {
  ...
  return (
    <div className="min-h-screen dark:bg-[#07090e] bg-[#f8fafc] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden select-none font-sans dark:text-slate-100 text-slate-800 transition-colors duration-200">
      ...
      >
        ...
        <div className="relative group">
          ...
          <div className="relative rounded-3xl border dark:border-white/[0.1] border-slate-200 dark:bg-[#0d1019]/90 bg-white/95 backdrop-blur-2xl p-7 sm:p-9 shadow-2xl overflow-hidden transition-colors">

            {/* Top Brand Header */}
            <motion.div variants={itemVariants} className="text-center mb-7">
              {/* Product Badge */}
              <div className="inline-flex items-center px-4 py-1.5 rounded-full dark:bg-[#141824]/90 bg-slate-100 dark:border-white/[0.12] border-slate-200 text-xs font-semibold dark:text-slate-200 text-slate-700 mb-4 shadow-sm backdrop-blur-xl">
            ...
            <motion.div variants={itemVariants} className="relative mb-5 text-center">
              ...
              <span className="relative px-3 text-[10px] font-bold text-slate-400 dark:text-slate-500 tracking-wider uppercase dark:bg-[#0d1019] bg-white">
                Sandbox Access
              </span>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="mb-4">
              <button
                ...
                className="w-full flex items-center justify-between p-3 rounded-2xl dark:bg-[#131722]/80 bg-slate-50 dark:hover:bg-[#181d2c] hover:bg-slate-100 border dark:border-white/[0.08] border-slate-200 hover:border-indigo-500/40 text-xs font-semibold dark:text-slate-300 text-slate-700 dark:hover:text-white hover:text-slate-900 transition-all group"
              >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      {MOCK_USERS.map((mockUser) => (
                        <button
                          ...
                          className="group text-left p-3 rounded-2xl dark:bg-[#121520] bg-slate-50 dark:hover:bg-[#181d2e] hover:bg-indigo-50/50 border dark:border-white/[0.06] border-slate-200 hover:border-indigo-500/40 transition-all flex flex-col justify-between shadow-sm relative overflow-hidden"
                        >
