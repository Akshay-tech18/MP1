        ...
        >
          ...
          <div className="space-y-1 pr-0.5">
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl dark:text-slate-300 text-slate-700 dark:hover:text-white hover:text-slate-900 dark:hover:bg-white/[0.06] hover:bg-slate-100 transition-colors group"
            >
